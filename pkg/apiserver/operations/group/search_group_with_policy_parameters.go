...
// SearchGroupWithPolicyParams contains all the bound params for the search group with policy operation
// typically these are obtained from a http.Request
//
// swagger:parameters searchGroupWithPolicy
...
//
// To ensure default values, the struct must have been initialized with NewSearchGroupWithPolicyParams() beforehand.
func (o *SearchGroupWithPolicyParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *SearchGroupWithPolicyParams) bindNamespace(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *SearchGroupWithPolicyParams) bindPolicyName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
